	...
	, ininame(_ininame)
{
	...
	// aspect-ratio
	{
	const wxString ar_choices[] = { _("Auto"), _("Analog TV (Wide)"), _("Analog TV"), _("Stretch to Window") };
